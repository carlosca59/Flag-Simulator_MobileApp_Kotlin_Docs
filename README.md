# Flag Simulator Mobile App Documentation 📱🏳️
...
4. **Run the App**: Use an emulator or a physical device to run the app and test your changes.
...
2. **Run Tests**: Execute the following command:
   ```bash
   ./gradlew test
   ```
3. **Review Results**: Check the test results to ensure everything is functioning correctly.
